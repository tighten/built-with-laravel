<nav class="mt-5 flex flex-1 gap-3 justify-center">
    <a
        href="/#about"
        class="rounded-lg px-6 py-1 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] bg-black/4 hover:bg-gray-200"
    >
        About
    </a>
